...
nat_p4 <- nation_last30 %>% ggplot(aes(x=date,y=deaths_delta_ma)) + 
    ...
    scale_x_date(date_breaks = "3 weeks", date_labels = "%b %d")+
    scale_y_continuous(breaks = breaks_extended(n=6), labels = scales::label_number(accuracy = 1), name = "Daily Cases", sec.axis = sec_axis(trans=~./nation_last30$population * 1000000, name = "Per Million People"))+
